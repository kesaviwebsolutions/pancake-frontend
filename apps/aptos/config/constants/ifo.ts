...
export const ifos: Ifo[] = [
  {
    id: 'USDC2',
    cIFO: false,
    address: `${IFO_POOL_STORE_TAG}<${mainnetTokens.usdt.address}, ${mainnetTokens.usdc.address}, ${getIFOUID(1)}>`,
    isActive: true,
    name: 'USDC',
    poolUnlimited: {
      saleAmount: '9 USDC',
  ...
  },
  {
    id: 'USDC',
    cIFO: false,
    address: `${IFO_POOL_STORE_TAG}<${mainnetTokens.dai.address}, ${mainnetTokens.usdc.address}, ${getIFOUID(1)}>`,
    isActive: true,
    name: 'USDC',
    poolUnlimited: {
      saleAmount: '9 USDC',
